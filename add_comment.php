...
<body>
    ...
    <main>
        ...
        <table>
            ...
            <tr>
                <td><label for="problems_comment">Добавить комментарий</label></td>
                <td><textarea id="problems_comment" name="problems_comment"></textarea></td>
            </tr>
            <tr>
                <td></td>
        ...
        <?php
        require_once("bd.php");
        if(!empty($_POST['problems_id'])&&!empty($_POST['problems_comment'])){
         $problems_id = $_POST['problems_id'];
         $problems_comment = $_POST['problems_comment'];
         $result = mysqli_query($link, "UPDATE problems SET problems_comment = '$problems_comment' WHERE problems_id = '$problems_id'");
        if($result =='true'){
